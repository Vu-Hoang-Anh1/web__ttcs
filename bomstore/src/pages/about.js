                ...
                <div className="row">
                    <div className="col-lg-4">
                        <div className="about-single-block">
                            <h2>OUR COMPANY</h2>
                            <b className="bold-text">Lorem ipsum dolor sit amet conse ctetur adipisicing elit,
                                sed do eiusmod tempor incididun.</b>
                    ...
                    <div className="col-lg-4">
                        <div className="about-single-block">
                            ...
                            <div className="about-team-image">
                                <img width="1114" height="742" src={AbouUs} className="img-fluid" alt=""/>
                            </div>
                            <b className="bold-text">Lorem set sint occaecat cupidatat non </b>
                            <p>Lorem ipsum dolor sit amet conse ctetur adipisicing elit, sed do eiusmod
                                tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim
                                veniam. Lorem ipsum dolor sit amet conse ctetur adipisicing elit. </p>
                        ...
                        <div className="about-single-block">
                            ...
                            <div className="testimonial-container">
                                <div className="single-testimonial">
                                    <p> <i><FontAwesomeIcon icon={faQuoteLeft} /></i> Lorem ipsum dolor sit amet conse
                                        ctetur adipisicing elit, sed do
                                        eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
                                        et dolore magna aliqua. Ut enim ad minim
                                        veniam. Lorem ipsum dolor sit amet conse ctetur adipisicing elit.
                                        ad minim. <i><FontAwesomeIcon icon={faQuoteRight} /></i></p>
