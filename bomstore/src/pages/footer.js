            ...
            <div className="container-xxl">
              <div className="row">
                <div className="col-4">
                  ...
                  <div style={{paddingLeft:"10px"}}>
                    ...
                    <div className="social_icons d-flex align-items-center gap-30 mt-4">
                      <a className="" href="#">
                      <FontAwesomeIcon icon={faPaperPlane} className="icon fs-4"/>
                      </a>
                      <a className="" href="#">
                      <FontAwesomeIcon icon={faPaperPlane} className="icon fs-4" />
                      </a>
                ...
                <div className="col-lg-2 col-md-6">
                  ...
                  <div className="footer-link d-flex flex-column">
                    <Link to="https://www.adidas.com.vn/en?cm_mmc=AdieSEM_Google-_-adidas-SEAPAC-eCom-PPC-B-Brand-Other-Exact-VN_EN-SEAPAC-eCom-Paid_Search_Bing-_-B-Other-Exact-EN_INDDAYSS23_Convert-_-adidas-_-dv:eCom&cm_mmc1=VN&cm_mmc2=e&gclid=8ba2cb734a4d1cda29a1af3f9356fbf2&gclsrc=3p.ds&"
                     className=" ">Adidas</Link>
                    <Link to = "https://supersports.com.vn/en/collections/nike"
                     className=" ">Nikes</Link>
                    <Link to = "https://vansvietnam.com.vn/" 
                    className=" ">Vans</Link>
                    <Link to = "https://www.balenciaga.com/en-en" 
                    className=" ">Balenciagas</Link>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
											<div class="payment-logos text-md-end text-center">
												<img width="252" height="28" src={payment} alt="payment logo"/>
											</div>
										</div>
              </div>
            </div>
